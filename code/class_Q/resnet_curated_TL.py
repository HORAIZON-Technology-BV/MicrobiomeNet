...
model = ResNet(**params)
model.load_state_dict(torch.load('../../data/raw/curated_metagenomics/resnet_curated_qin.pt'))
print(model)
...
def get_target_data():
    ...
    target_metadata = metadata.loc[metadata.study_name == 'QinN_2014',:]
...
output_path = '../../data/output/class_Q_TL_'
